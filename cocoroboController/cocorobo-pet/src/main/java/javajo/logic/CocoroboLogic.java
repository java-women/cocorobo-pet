...
public class CocoroboLogic {
	...
	public String getMoveDirection() throws IOException {
		...
		RedisValue redisValue = getRequestRedisValue();
	 ...
	 * @throws IOException
	 */
	private RedisValue getRequestRedisValue() throws IOException {
		// userに紐づく情報を取得
		...
		RedisValue redisValue = jacsonHelper.stringToJson(userInfo);
